...
export const landingPageSeo = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description:
        'The FAQ block on this page is built from this list. Pick any FAQ Item documents to include (add via FAQ Items in the sidebar), then drag to set order. Common setup: on the Home doc pick the ~6 highest-priority questions; on the FAQ doc include every question you want on /faq. Empty array = no FAQ section on the page.',
    }),
